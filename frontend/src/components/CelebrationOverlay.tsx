            ...
            {isVisible && (
                ...
                >
                    ...
                    <motion.div
                        ...
                        animate={{ y: 0, opacity: 1 }}
                        transition={{ delay: 1 }}
                        className="w-full p-8 border-t-2 border-gray-100 flex items-center justify-between max-w-4xl mx-auto bg-white mb-4"
                    >
                        ...
                        {/* Continue Button - Using Blue to match Lottie character */}
                        <button
                            onClick={onComplete}
