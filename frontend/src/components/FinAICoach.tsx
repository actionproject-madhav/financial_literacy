...
interface FinAICoachProps {
  isOpen: boolean;
  onClose: () => void;
}

export function FinAICoach({ isOpen, onClose }: FinAICoachProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-[#f7f7f7] rounded-2xl w-full max-w-lg h-[600px] max-h-[90vh] flex flex-col shadow-2xl border-2 border-gray-200">
        {/* Header */}
        <div className="bg-white border-b-2 border-gray-200 p-4 rounded-t-2xl flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#58cc02] rounded-full flex items-center justify-center">
        ...
        {/* Input */}
        <form onSubmit={handleSubmit} className="p-4 bg-white border-t-2 border-gray-200 rounded-b-2xl">
